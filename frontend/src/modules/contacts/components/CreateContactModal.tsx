    ...
    >
      <section className="bg-white border border-outline-variant rounded-lg p-6 space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="space-y-2">
            <label className="text-[12px] text-gray-600 block">Contact Website</label>
            <div className="flex rounded-lg shadow-sm border bg-white overflow-hidden border-outline-variant">
              ...
              <input
                className={`flex-1 px-3 py-2 bg-transparent text-body-base outline-none text-[14px] ${state.errors.website ? "text-red-600" : ""}`}
      ...
      <section className="bg-white border border-outline-variant rounded-lg p-6">
        ...
        <div className="grid grid-cols-2 gap-4 mb-6">
          {[
            { id: "AlternativeEmail", label: "Alternative Email", sub: "Work" },
        ...
        <div className="space-y-4 empty:hidden transition-all duration-300">
          {state.channels?.includes("AlternativeEmail") && (
            <div className="space-y-1.5">
              <label className="text-[12px] font-medium text-gray-600">Alternative Email Address</label>
              <input
                className={`${baseInputStyles} ${state.errors.alternativeEmailValue ? errorInputStyles : regularInputStyles}`}
                type="email"
                placeholder="alternative@domain.com"
                {...actions.register("alternativeEmailValue")}
              />
              {state.errors.alternativeEmailValue && (
                <p className="text-red-500 text-[11px] font-medium flex items-center gap-1 mt-1">
                  <AlertCircle size={14} /> {state.errors.alternativeEmailValue.message}
                </p>
              )}
            </div>
          )}
          {state.channels?.includes("WhatsApp") && (
            <div className="space-y-1.5">
              ...
              <div className="flex rounded-lg shadow-sm border bg-white overflow-hidden border-outline-variant">
                ...
                <input className="flex-1 px-3 py-2 bg-transparent text-body-base outline-none text-[14px]" type="text" placeholder="15550000000" {...actions.register("whatsappValue")} />
              </div>
            </div>
          )}
          {state.channels?.includes("LinkedIn") && (
            <div className="space-y-1.5">
              <label className="text-[12px] font-medium text-gray-600">LinkedIn Profile</label>
              <div className="flex rounded-lg shadow-sm border bg-white overflow-hidden border-outline-variant">
                <span className="bg-gray-50 px-3 py-2 text-[14px] text-gray-400 border-r border-outline-variant select-none">{URL_FIELD_PREFIXES.linkedinProfile}</span>
                <input className="flex-1 px-3 py-2 bg-transparent text-body-base outline-none text-[14px]" type="text" placeholder="username" {...actions.register("linkedinValue")} />
              </div>
            </div>
          )}
          {state.channels?.includes("Instagram") && (
            <div className="space-y-1.5">
              ...
              <div className="flex rounded-lg shadow-sm border bg-white overflow-hidden border-outline-variant">
                ...
                <input className="flex-1 px-3 py-2 bg-transparent text-body-base outline-none text-[14px]" type="text" placeholder="username" {...actions.register("instagramValue")} />
              </div>
            </div>
          )}
          {state.channels?.includes("Twitter") && (
            <div className="space-y-1.5">
              ...
              <div className="flex rounded-lg shadow-sm border bg-white overflow-hidden border-outline-variant">
                ...
                <input className="flex-1 px-3 py-2 bg-transparent text-body-base outline-none text-[14px]" type="text" placeholder="username" {...actions.register("twitterValue")} />
              </div>
            </div>
          )}
        </div>
