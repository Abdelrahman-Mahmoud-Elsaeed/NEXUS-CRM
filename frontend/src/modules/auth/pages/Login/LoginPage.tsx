...
import loginBackgournd from "@assets/loign-background.png";
import { Link } from "react-router-dom";
import { useLogin } from "@modules/auth/hooks/useLogin"; // Adjust path as needed
  ...
  return (
    <div className="flex min-h-screen w-full bg-background font-sans text-foreground">
      <div className="flex w-full flex-col justify-center px-6 py-12 lg:w-1/2 lg:px-16 xl:px-24">
        <div className="mx-auto w-full max-w-[400px] space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
          ...
          <form className="space-y-5" onSubmit={onSubmit}>
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  className={`pl-10 bg-surface text-foreground placeholder:text-outline focus-visible:ring-primary ${
                    errors.email ? "border-destructive" : "border-outline-variant"
                  }`}
                />
              </div>
              {errors.email && (
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  placeholder="••••••••"
                  className={`pl-10 bg-surface text-foreground placeholder:text-outline focus-visible:ring-primary ${
                    errors.password ? "border-destructive" : "border-outline-variant"
                  }`}
                />
              </div>
              {errors.password && (
            ...
            <Button
              type="submit"
              disabled={loading}
              className="w-full bg-primary text-on-primary hover:bg-primary/90 rounded-[var(--radius-md)] transition-all"
            >
