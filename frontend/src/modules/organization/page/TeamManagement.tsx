  ...
  return (
    <main className="bg-surface-bright font-sans antialiased">
      <div className="p-6 md:p-8 space-y-6">
        ...
        {/* Tab Selection Header Header Bar Row */}
          ...
          {tabs.map((tab) => {
            ...
            return (
              ...
              >
                ...
                {isActive && (
                  <div className="absolute bottom-0 left-0 w-full h-0.5 bg-primary animate-in fade-in layout duration-200" />
                )}
              </button>
            );
          })}
