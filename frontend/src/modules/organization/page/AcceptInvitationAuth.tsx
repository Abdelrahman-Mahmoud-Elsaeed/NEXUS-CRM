...
import { useAcceptInvitationAuth } from "@/modules/organization/hooks/useAcceptInvitationAuth";
...
export const AcceptInvitationAuth: React.FC = () => {
  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center bg-[#fcf8ff] p-4 font-sans relative overflow-hidden select-none">
      ...
      <div className="max-w-[480px] w-full flex flex-col items-center animate-[slideUp_0.6s_ease-out_forwards]">
