...
import { Network, ArrowRight, ShieldCheck, LogIn } from "lucide-react";
import {
  Card,
  CardContent,
  CardHeader,
      ...
      <Card className="w-full max-w-120 bg-white border-slate-200 shadow-sm z-10 p-2">
        ...
        <CardContent className="space-y-6">
          <div className="bg-slate-50/80 rounded-lg p-4 flex items-center gap-4 border border-slate-100">
            ...
            <div>
              <p className="text-sm text-slate-700">
                <span className="font-bold text-slate-900">{inviterName}</span>{" "}
                has invited you
              </p>
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
            <p className="text-sm text-slate-700">
              We detected that you already have an account with us. Please sign
