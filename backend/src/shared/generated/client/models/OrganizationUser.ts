...
export type OrganizationUserWhereInput = {
  ...
  role?: Prisma.EnumRoleFilter<"OrganizationUser"> | $Enums.Role
...
export type OrganizationUserScalarWhereWithAggregatesInput = {
  ...
  role?: Prisma.EnumRoleWithAggregatesFilter<"OrganizationUser"> | $Enums.Role
...
export type OrganizationUserOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"organizationId" | "userId" | "role" | "createdAt", ExtArgs["result"]["organizationUser"]>
...
export interface OrganizationUserDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * const organizationUserWithOrganizationIdOnly = await prisma.organizationUser.findMany({ select: { organizationId: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many OrganizationUsers and only return the `organizationId`
   * const organizationUserWithOrganizationIdOnly = await prisma.organizationUser.createManyAndReturn({
   ...
   * })
   * 
   * // Update zero or more OrganizationUsers and only return the `organizationId`
   * const organizationUserWithOrganizationIdOnly = await prisma.organizationUser.updateManyAndReturn({
   *   select: { organizationId: true },
   *   where: {
   *     // ... provide filter here
   *   },
...
export interface OrganizationUserFieldRefs {
  ...
  readonly role: Prisma.FieldRef<"OrganizationUser", 'Role'>
